  ...
  */
  ...
  (function ($, Drupal) {
    ...
    $(document).ready(function () {
      ...
      $('#descubreBtn .terciary').attr('id', 'quiz-nav'); // DATA LAYER EVENT
      // $('#last-button').click(function(){
      //     window.dataLayer = window.dataLayer || [];
      //     // window.dataLayer.push({'event': 'quizcoronado'});
      ...
      //   });
      // });
      // SEARCH BTN DATA LAYER
      // $('#btn_search').click(function(){
      //   console.log('Search');
      //     window.dataLayer = window.dataLayer || [];
      //     window.dataLayer.push({
      //       event: 'buscador',
      //       busqueda: $("input[name=keys]").val()
      //   });
      // });
      // ID video-btn
      ...
      if ($('.path-frontpage').length) {
        ...
        $('#slider-receta img').each(function (i) {
          $(this).attr('id', 'receta-perfilador-' + i); // $(this).addClass('btn-a ');
          // You can also add more code here if you wish to manipulate each IMG element further
        });
        $('#slider-receta p').each(function (i) {
          $(this).attr('id', 'receta-perfilador-' + i); // $(this).addClass('btn-a ');
          // You can also add more code here if you wish to manipulate each IMG element further
        }); // SWIPER QUIZ
        ...
        $('#modal').on('shown.bs.modal', function (e) {
          ...
          // var selectMenu = document.querySelector('#recipe-ocasion');
        ...
        // OCASION DROPDOWN MENU

        /*(function() {
          var selectMenu = document.querySelector('#recipe-ocasion');
          var selectMenuP = document.querySelector('#recipe-producto');
          var callback = function(e) {
          window.selectedOption = selectMenu.options[selectMenu.selectedIndex].id;
          window.selectedOptionP = selectMenuP.options[selectMenuP.selectedIndex].id;
          //  window.dataLayer.push({
         ...
         selectMenuP.addEventListener('change', callback, true);
             })();*/
        // $("#recipe-ocasion").on("change", function () {

        $("#recipe-ocasion").change(function () {
          // var selectMenu = document.querySelector('#recipe-ocasion');
          // var selectMenu = $(this);
          window.selectedOption = $("#recipe-ocasion option:selected").val();
          console.log(selectedOption);
          window.dataLayer = window.dataLayer || [];
          window.dataLayer.push({
            'event': selectedOption
          }); // var callback = function(e) {
          // var selectedOption = selectMenu.options[selectMenu.selectedIndex].val;
          // var selectedOption = $("#recipe-product option:selected").val();
          // console.log(selectedOption);
          // window.dataLayer = window.dataLayer || [];
          // window.dataLayer.push({'event': selectedOption});
          //  window.dataLayer.push({
        ...
        $("#recipe-product").change(function () {
          window.selectedOptionP = $("#recipe-product option:selected").val();
          console.log(selectedOptionP);
          window.dataLayer = window.dataLayer || [];
          window.dataLayer.push({
            'event': selectedOptionP
          }); // var selectMenuP = document.querySelector('#recipe-product');
          // var callback = function(e) {
          // var selectedOptionP = selectMenuP.options[selectMenuP.selectedIndex].id;
          // var selectedOptionP = $("#recipe-product option:selected").val();
          //   console.log(selectedOptionP);
          //   window.dataLayer = window.dataLayer || [];
          //   window.dataLayer.push({'event': selectedOptionP});
          // console.log(selectedOption);
          //  window.dataLayer.push({
          //    event: selectedOption,
          //    // selectedElement: selectedOption
      ...
      if ($('.productos-detail').length) {
        ...
        var buttonID = function buttonID() {
          $(".swiper-slide-active p").each(function () {
            var productPath = $(this).text().toLowerCase(); // var recipename = hrefPath.lastIndexOf('/');
            // var result = productPath.replace("/,/g", "");

            var result = productPath.replaceAll(',', '');
            var resultT = productPath.replaceAll(/[^0-9a-zA-Z. ]/g, '');
            var splitP = resultT.split(" "); // splitP.splice(1, 1);

            var resultP = splitP.join('-'); // console.log('Presentaciones ' + resultP);

            $('.swiper-button-prev').attr('id', function (index) {
              return 'prev-' + resultP;
            });
            $('.swiper-button-next').attr('id', function (index) {
              return 'next-' + resultP;
            }); // $.each(resultP, function(i, item) {
            //   console.log(resultP[i]);
            // });
            // cnt++;
          });
        }; // CLICK
      ...
      if ($('.productos-grid').length) {
        $(".card-topics .primary").each(function () {
          var hrefPath = $(this).attr('href'); // var recipename = hrefPath.lastIndexOf('/');
        ...
        var cnt = 1;
        $(".card-topics .text-right").each(function () {
          $(this).attr('id', function (index) {
            return 'link-producto-' + cnt++;
          });
          cnt++;
      ...
      // if ($('.grid-recetas').length) {
      //   $(".grid--wrap__card a").each(function () {
      //     var hrefPath = $(this).attr('href');
      //     // var recipename = hrefPath.lastIndexOf('/');
      //     var split = hrefPath.split("/");
      //     split.splice(1, 1);
      //     hrefPath = split.join('-')
      //     console.log('URL lastname ' + hrefPath);
      ...
      if ($('.recipe').length) {
        ...
        $('#facebook a').each(function (i) {
          $(this).attr('id', 'facebook-a'); // $(this).addClass('btn-a ');
          // You can also add more code here if you wish to manipulate each IMG element further
        });
        $('#whatsapp a').each(function (i) {
          $(this).attr('id', 'whatsapp-a'); // $(this).addClass('btn-a ');
          // You can also add more code here if you wish to manipulate each IMG element further
        }); //INIT FULLPAGE
      ...
      jQuery("#last-button").click(function () {
        ...
        var ocasion = selectedOption; // var ocasion = selectedOption;
        // var producto = jQuery("#recipe-product option:selected").val();

        var producto = selectedOptionP;
