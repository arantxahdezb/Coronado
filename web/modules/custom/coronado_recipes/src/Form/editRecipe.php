 ...
 */
class editRecipe extends FormBase
{
  ...
  {
    return 'coronado_recipes_editRecipe';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $arg = null)
  {
    ...
    $steps = unserialize($recipe['steps']);
    ...
    $form['description'] = array(
      ...
      '#maxlength' => 255,
      '#required' => TRUE,
      '#default_value' => $recipe['description'],
    );
    ...
    $form['image_preview'] = [
      ...
      '#required' => TRUE,
      '#default_value' => [$recipe['image_preview']],
    ];
    ...
    if ($num_steps === NULL) {
      $form_state->set('num_steps', count($steps));
    ...
    if ($num_ingredients === NULL) {
      $form_state->set('num_ingredients', count($ingredients));
    ...
    $form['temporality'] = array(
      ...
      '#default_value' => unserialize($recipe['temporality']),
      '#required' => TRUE,
    );
    ...
    $form['video_link'] = array(
      ...
      '#size' => 25,
      '#maxlength' => 25,
      '#default_value' => $recipe['video_link'],
    );
    ...
    $form['meta_title'] = array(
      ...
      '#size' => 100,
      '#maxlength' => 100,
      '#default_value' => $recipe['meta_title'],
      '#required' => true,
    );
    ...
    $form['meta_description'] = array(
      ...
      '#size' => 255,
      '#maxlength' => 255,
      '#default_value' => $recipe['meta_description'],
      '#required' => true,
    );
    ...
    $form['meta_keywords'] = array(
      ...
      '#size' => 255,
      '#maxlength' => 255,
      '#default_value' => $recipe['meta_keywords'],
    );

    $form['url'] = array(
      '#type' => 'textfield',
      '#title' => $this->t('URL'),
      '#default_value' => $recipe['url'],
      '#maxlength' => 100,
      '#required' => TRUE,
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state)
  {
    ...
    $connection->update('coronado_recipes')
      ->fields($campos)
      ->condition('id', $id)
      ->execute();
    ...
    \Drupal::messenger()->addStatus($this->t('La receta @name fue actualizada exitosamente', array('@name' => $form_state->getValue('name'))));
